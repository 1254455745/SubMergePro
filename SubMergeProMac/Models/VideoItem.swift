...
struct SubtitleAppearance: Codable, Equatable {
    ...
    var outlineWidth: Int = 3
    var shadowColorHex: String = "#07080E"
    var shadowOpacity: Int = 43
    var shadowDistance: Int = 1
    var shadowBlur: Int = 0
    ...
    var rotation: Int = 0
    var marginLeft: Int = 135
    var marginRight: Int = 135
    var marginVertical: Int = 72
